...
setenv regrid_1   0
setenv method_1   conserve # bilinear, patch, conserve, neareststod, and nearestdtos
setenv old_res_1  SE_NE30NP3
setenv new_res_1  1x1   # 0.5x0.5; fv1deg
setenv wgt_dir_1  /diagnostics/noresm-diagnostics-src/packages/CLM_DIAG/regriddingFiles/ne30pg3/
if ( ! -d $wgt_dir_1 ) then
...
setenv wgt_file_1 "map_ne30pg3_to_1x1d_aave.nc"
#setenv area_dir_1 /diagnostics/noresm/packages/CLM_DIAG/regriddingFiles
#setenv area_file_1 $new_res_1"_area.nc"

setenv regrid_2   0
setenv method_2   conserve # bilinear, patch, conserve, neareststod, and nearestdtos
setenv old_res_2  SE_NE30NP3
setenv new_res_1  1x1   # 0.5x0.5; fv1deg
setenv wgt_dir_2  /diagnostics/noresm-diagnostics-src/packages/CLM_DIAG/regriddingFiles/ne30pg3/
if ( ! -d $wgt_dir_2 ) then
...
setenv wgt_file_2 "map_ne30pg3_to_1x1d_aave.nc"
