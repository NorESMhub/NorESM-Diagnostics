...
if [ $nl -ge 1 ]; then
  echo "<TABLE width='80%'>" >> $WEBDIR/index.html
  echo "<TR>" >> $WEBDIR/index.html
  if [ -f $WEBDIR/set1/set1_ann_tempga_${cinfo}.png ];then
    echo "    <TH>Temperature <br> (tempga)" >> $WEBDIR/index.html
  else
    echo "    <TH>Temperature" >> $WEBDIR/index.html
  fi
  if [ -f $WEBDIR/set1/set1_ann_salnga_${cinfo}.png ];then
      echo "<TH>Salinity <br> (salnga)" >> $WEBDIR/index.html
  else
    echo "    <TH>Salnity" >> $WEBDIR/index.html
  fi
  if [ -f $WEBDIR/set1/set1_ann_sstga_${cinfo}.png ];then
      echo "<TH>SST <br> (sstga)" >> $WEBDIR/index.html
  else
    echo "    <TH>SST" >> $WEBDIR/index.html
  fi
  if [ -f $WEBDIR/set1/set1_ann_sssga_${cinfo}.png ];then
      echo "<TH>SSS <br> (sssga)" >> $WEBDIR/index.html
  else
    echo "    <TH>SSS" >> $WEBDIR/index.html
  fi
  echo "</TR>" >> $WEBDIR/index.html
  if [ -f $WEBDIR/set1/set1_ann_tempga_${cinfo}.png ];then
      echo "<TD><a target="_self" href='set1/set1_ann_tempga_CINFO.png'><img src="set1/set1_ann_tempga_CINFO.png" alt="Temperature"></a>" >> $WEBDIR/index.html
    else
      echo "<TD><a target="_self" href='set1/set1_ann_temp_CINFO.png'><img src="set1/set1_ann_temp_CINFO.png" alt="Temperature"></a>" >> $WEBDIR/index.html
  fi
  if [ -f $WEBDIR/set1/set1_ann_salnga_${cinfo}.png ];then
      echo "<TD><a target="_self" href='set1/set1_ann_salnga_CINFO.png'><img src="set1/set1_ann_salnga_CINFO.png" alt="Salinity"></a>" >> $WEBDIR/index.html
  else
      echo "<TD><a target="_self" href='set1/set1_ann_saln_CINFO.png'><img src="set1/set1_ann_saln_CINFO.png" alt="Salinity"></a>" >> $WEBDIR/index.html
  fi
  if [ -f $WEBDIR/set1/set1_ann_sstga_${cinfo}.png ];then
      echo "<TD><a target="_self" href='set1/set1_ann_sstga_CINFO.png'><img src="set1/set1_ann_sstga_CINFO.png" alt="SST"></a>" >> $WEBDIR/index.html
  else
      echo "<TD><a target="_self" href='set1/set1_ann_sst_CINFO.png'><img src="set1/set1_ann_sst_CINFO.png" alt="SST"></a>" >> $WEBDIR/index.html
  fi
  if [ -f $WEBDIR/set1/set1_ann_sssga_${cinfo}.png ];then
      echo "<TD><a target="_self" href='set1/set1_ann_sssga_CINFO.png'><img src="set1/set1_ann_sssga_CINFO.png" alt="SSS"></a>" >> $WEBDIR/index.html
  else
      echo "<TD><a target="_self" href='set1/set1_ann_sss_CINFO.png'><img src="set1/set1_ann_sss_CINFO.png" alt="SSS"></a>" >> $WEBDIR/index.html
  fi
  echo "</TR>" >> $WEBDIR/index.html
